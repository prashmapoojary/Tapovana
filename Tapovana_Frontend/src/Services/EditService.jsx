...
function EditService({ service, onBack }) {
    ...
    const fetchServiceDetails = async () => {
        try {
            ...
            if (data.success && data.service) {
                ...
                if (s.benefits) setBenefits(s.benefits.split('\n'));
                if (s.tools) setTools(s.tools.split('\n'));
                if (s.image_url) setGalleryImages([s.image_url]);

                if (s.required_certification) {
                    const certs = s.required_certification.split('\n');
    ...
    const addTool = () => {
        if (newTool.trim()) { setTools([...tools, newTool.trim()]); setNewTool(''); }
    };
        ...
        <div className="edit-service-page">
            ...
            <div className="es-sticky-top">
                ...
                <nav className="es-nav">
                    ...
                    <span className="es-nav-current">Edit Service</span>
                </nav>
                ...
                <div className="es-header">
                    <div className="es-header-left">
                        ...
                        <p className="es-subtitle">Update service details, pricing, and specialist requirements for the mobile app.</p>
                    </div>
                    <div className="es-header-actions">
                        <button className="es-btn-discard" onClick={onBack}>Discard</button>
                        <button className="es-btn-update" onClick={handleUpdateService} disabled={updating}>
            ...
            <div className="es-scroll-body">
                {loading ? (
                    <div style={{ padding: '40px', textAlign: 'center', fontFamily: 'Manrope, sans-serif', color: '#64748B' }}>
                        ...
                        <div className="es-body">
                            ...
                            <div className="es-col-left">
                                                ...
                                                {categoryOpen && (
                                                    <div className="es-dropdown">
                                                        {categoryOptions.map(opt => (
                                                            <div key={opt} className="es-dropdown-item"
                                ...
                                <div className="es-card">
                                    ...
                                    <p className="es-section-hint">These will appear as bullet points in the service detail view on the customer app.</p>
